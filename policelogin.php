...
if(isset($_POST['s']))
{
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        //password enctypt
        $password=md5($pass);
        $result=mysqli_query($conn,"SELECT p_id,p_pass FROM police where p_id='$name' and p_pass='$password' ");
        $_SESSION['pol']=$name;       
...
<nav>
	...
	<ul class="links">
          ...
          <li><a href="policelogin.php"  class="active">Police Login</a></li>
...
<label for="exampleInputEmail1"  ><h1 style="color:white; margin-left:130px">Police Id</h1></label>
